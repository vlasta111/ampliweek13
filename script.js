class Calculator{
    constructor(previousOperandTextElment, currentOperandTextElement){
        ...
        this.currentOperandTextElment = currentOperandTextElement
        this.clear()
    }
    ...
    updateDisplay(){
        ...
        if (this.operation != null) {
            this.previousOperandTextElment.innerText = `${this.getDisplayNumber(this.previousOperand)} ${this.operation}`
        } else {
